...
/**
 * The AppServer class handles client connections, authenticates users, and manages user sessions.
 * This server listens on port 9999 and continuously accepts incoming client connections.
 * Upon connection, it authenticates users and initiates a dedicated thread to handle further client-server interaction.
 */
