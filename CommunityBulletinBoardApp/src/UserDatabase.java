...
/**
 * Team Project(Project 05) -- UserDatabase
 * <p>
 * This class is the database for the project,
 * can read and write user related information from/to files,
 * also has search and view user functions
 *
 * @author Lab01, Team 4
 * @version Apr 1, 2024
 */
    ...
    public void readUsers() {
        try (BufferedReader reader = new BufferedReader(new FileReader(userFile))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                String password = userInfo[3].trim();
                String bio = userInfo[4].trim();
