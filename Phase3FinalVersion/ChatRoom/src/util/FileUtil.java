...
public class FileUtil {
    ...
    public static ConcurrentHashMap<String, User> getUsers() {
        ...
        try {
            fileIn = new FileInputStream("/Users/jinjei/IdeaProjects/cs180/project/phase3/UserPic1/user1.txt");
    ...
    public static int setUser(ConcurrentHashMap<String, User> users) {
        ...
        try {
            fileOut = new FileOutputStream("/Users/jinjei/IdeaProjects/cs180/project/phase3/UserPic1/user1.txt");
