...
/**
 * Team Project(Project 05) -- CommunityBulletinBoard
 * <p>
 * This class includes the main method of our project
 *
 * @author Lab01, Team 4
 * @version Apr 1, 2024
 */
public class CommunityBulletinBoard {
    ...
    public static void main(String[] args) {
        ...
        User currentUser = new User(name, username, email, password);


        System.out.println("Account created! Let's set up your profile.");
